...
const Home = ({
  ...
  const sortUserByAttr = (users, attribute) => {
    ...
    switch (attribute) {
          ...
          a.firstname.toLowerCase() > b.firstname.toLowerCase()
            ...
            ? a.lastname.toLowerCase() > b.lastname.toLowerCase()
              ...
              ? a.phoneNumber > b.phoneNumber
                ? 1
                : a.phoneNumber === b.phoneNumber
                ? a.email.toLowerCase().slice(0, 1) >
                  b.email.toLowerCase().slice(0, 1)
                  ? 1
                  : -1
                : -1
              : -1
      ...
      case 'email':
        return [...users].sort((a, b) =>
          a.email.toLowerCase().slice(0, 1) > b.email.toLowerCase().slice(0, 1)
            ? 1
            : a.email.toLowerCase().slice(0, 1) ===
              b.email.toLowerCase().slice(0, 1)
            ? a.firstname.toLowerCase() > b.firstname.toLowerCase()
    ...
    return users.filter(
      user =>
        ...
        user.lastname
          .toLowerCase()
          .indexOf(queryCur.toString().toLowerCase()) !== -1 ||
        user.email.toLowerCase().indexOf(queryCur.toString().toLowerCase()) !==
          -1 ||
        user.phoneNumber.toString().indexOf(queryCur.toString()) !== -1
    );
  };
